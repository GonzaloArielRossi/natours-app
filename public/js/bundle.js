...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZ29uemFsb2FyaWVscm9zc2kiLCJhIjoiY2w3dzM1YzhqMGNlbDN1bGUzZTUzMjliaCJ9.f2aA06sjV7o-7EMKkondTw'; // mapboxgl.accessToken = process.env.YOUR_MAPBOX_ACCESS_TOKEN;
...
var login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(email, pwd) {
    var res;
...
var signup = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(email, name, pwd, pwdConfirm) {
    var signupBtn, res;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'pwd' ? '/api/v1/users/updateMyPassword' : '/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe('pk_test_51LkAPLA7Z2g9sDcSw3AfVXAUfdMVpniSsDlPlqFdPzzdNlfnSvJ3PVjcN81HfCdTKQ001SujUhkVCnXg1Om7jXzS00budamamg');
...
var signupBtn = document.getElementById('signupBtn'); // DELEGATION
...
if (signupForm) signupForm.addEventListener('submit', function (e) {
  ...
  (0, _login.signup)(email, name, pwd, pwdConfirm);
});
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            pwdCurrent = document.getElementById('password-current').value;
            pwd = document.getElementById('password').value;
            pwdConfirm = document.getElementById('password-confirm').value;
            _context.next = 7;
